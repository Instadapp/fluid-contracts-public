...
contract LiquidityUserModuleYieldTests is LiquidityUserModuleBaseTest {
    ...
    function test_operate_ExchangePriceSupplyWithInterestOnly() public {
        ...
        _supply(address(liquidity), mockProtocolWithInterest, address(USDC), alice, DEFAULT_BORROW_AMOUNT * 100);
    ...
    function test_operate_ExchangePriceSupplyInterestFreeOnly() public {
        // alice supplies liquidity
        _supply(address(liquidity), mockProtocolInterestFree, address(USDC), alice, DEFAULT_BORROW_AMOUNT * 100);
    ...
    function test_operate_ExchangePriceWhenSupplyWithInterestBigger() public {
        ...
        _supply(address(liquidity), mockProtocolWithInterest, address(USDC), alice, (DEFAULT_BORROW_AMOUNT * 80) / 100);

        // alice supplies liquidity interest free
        _supply(address(liquidity), mockProtocolInterestFree, address(USDC), alice, (DEFAULT_BORROW_AMOUNT * 20) / 100);
    ...
    function test_operate_ExchangePriceWhenSupplyInterestFreeBigger() public {
        // alice supplies liquidity with interest
        _supply(address(liquidity), mockProtocolWithInterest, address(USDC), alice, DEFAULT_BORROW_AMOUNT * 20);

        // alice supplies liquidity interest free
        _supply(address(liquidity), mockProtocolInterestFree, address(USDC), alice, DEFAULT_BORROW_AMOUNT * 80);
    ...
    function test_operate_ExchangePriceWhenSupplyWithInterestExactlySupplyInterestFree() public {
        // alice supplies liquidity with interest
        _supply(address(liquidity), mockProtocolWithInterest, address(USDC), alice, DEFAULT_BORROW_AMOUNT * 50);

        // alice supplies liquidity interest free
        _supply(address(liquidity), mockProtocolInterestFree, address(USDC), alice, DEFAULT_BORROW_AMOUNT * 50);
    ...
    function test_operate_ExchangePriceWhenSupplyWithInterestBiggerWithRevenueFee() public {
        ...
        // alice supplies liquidity with interest
        _supply(address(liquidity), mockProtocolWithInterest, address(USDC), alice, DEFAULT_BORROW_AMOUNT * 80);

        // alice supplies liquidity interest free
        _supply(address(liquidity), mockProtocolInterestFree, address(USDC), alice, DEFAULT_BORROW_AMOUNT * 20);
    ...
    function test_operate_ExchangePriceSequences() public {
        // alice supplies liquidity
        _supply(address(liquidity), mockProtocolWithInterest, address(USDC), alice, DEFAULT_BORROW_AMOUNT * 10);
...
abstract contract LiquidityUserModuleYieldCombinationBaseTest is LiquidityUserModuleBaseTest {
    ...
    function test_operate_YieldCombinationTest() public {
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 4 ether);
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 6 ether - 4000015200000000000); // bring total supply to 6 ether
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 6.2 ether - 6006269999999999817); // bring total supply to 6.2 ether
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 7.5 ether - 6671199999995069720); // bring total supply to 7.5 ether
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 8.5 ether - 8408437499994109082); // bring total supply to 8.5 ether
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 8.8 ether - 8790699999998441369); // bring total supply to 8.8 ether
        ...
        // 7. test yield at max
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 9.6 ether - 8819807473967845584); // bring total supply to 9.6 ether
    ...
    function _assertState(
        ...
        _supply(address(liquidity), mockProtocolInterestFree, address(USDC), alice, 30 ether);
        ...
        if (userSupplyData.withdrawable > 0) {
            ...
            _withdraw(address(liquidity), mockProtocol, address(USDC), alice, userSupplyData.withdrawable - 1);
            // supply it back
            _supply(address(liquidity), mockProtocol, address(USDC), alice, userSupplyData.withdrawable - 1);
        }
        ...
        _withdraw(address(liquidity), mockProtocolInterestFree, address(USDC), alice, 30 ether);
