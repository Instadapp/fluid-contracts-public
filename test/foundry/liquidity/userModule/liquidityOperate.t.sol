...
contract LiquidityUserModuleOperateTests is LiquidityUserModuleBaseTest {
    ...
    function test_operate_RevertTokenPaused() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Error.FluidLiquidityError.selector, ErrorTypes.UserModule__TokenPaused));
...
contract LiquidityUserModuleOperateTotalAmountsOverflowTests is LiquidityUserModuleBaseTest {
    function setUp() public virtual override {
        ...
        _supplyMax(mockProtocol, address(USDC), alice);
    }
    ...
    function test_operate_RevertValueOverflowTotalSupplyInterestFree() public {
        _supplyMax(mockProtocolInterestFree, address(USDC), alice);
    ...
    function test_operate_RevertValueOverflowTotalBorrowWithInterest() public {
        ...
        _borrowMax(mockProtocol, address(USDC), alice);
    ...
    function test_operate_RevertValueOverflowTotalBorrowInterestFree() public {
        ...
        _borrowMax(mockProtocolInterestFree, address(USDC), alice);
...
contract LiquidityUserModuleOperateExchangePricesStorageUpdateTests is LiquidityUserModuleBaseTest {
    ...
    function test_operate_StorageUpdateBecauseOfTimeDiff() public {
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 100); // supply insignificant amount that would not cause an update
    ...
    function test_operate_StorageUpdateBecauseOfSupplyRatioAboveUpdateThreshold() public {
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 0.011 ether);
    ...
    function test_operate_NoStorageUpdateBelowUpdateThresholdSupplyRatio() public {
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 0.0099 ether);
    ...
    function test_operate_StorageUpdateBecauseOfSupplyRatioModeChangeBelowUpdateThreshold() public {
        ...
        _supply(address(liquidity), mockProtocolInterestFree, address(USDC), alice, 0.001 ether);
    ...
    function test_operate_StorageUpdateBecauseOfSupplyRatioModeChangeAboveUpdateThreshold() public {
        ...
        // supply interest free is > supply with interest for the first time
        _supply(address(liquidity), mockProtocolInterestFree, address(USDC), alice, 0.011 ether);
    ...
    function test_operate_StorageUpdateBecauseOfBorrowRatioAboveUpdateThreshold() public {
        ...
        _supply(address(liquidity), mockProtocolInterestFree, address(USDC), alice, 1_000_000 ether);
    ...
    function test_operate_RevertValueOverflowUtilization() public {
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 1 ether);
    }
    ...
    function test_operate_RevertValueOverflowSupplyExchangePrice() public {
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 5 ether);
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 20_000_000_000 ether); // enough to trigger storage update
    }
    ...
    function test_operate_RevertValueOverflowBorrowExchangePrice() public {
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 10_000 ether);

        _supply(address(liquidity), mockProtocol, address(USDC), alice, 100_000_000 ether - 10_000 ether);
        _borrow(mockProtocol, address(USDC), alice, 1 ether);
...
contract LiquidityUserModuleOperateAmountInsufficientTests is LiquidityUserModuleBaseTest {
    function setUp() public virtual override {
        ...
        mockProtocol.operate(address(USDC), int256(1e20), int256(0), address(0), address(0), abi.encode(alice));
        mockProtocol.operate(address(USDC), int256(1e24), int256(0), address(0), address(0), abi.encode(alice));
        mockProtocol.operate(address(USDC), int256(1e28), int256(0), address(0), address(0), abi.encode(alice));

        mockProtocol.operate(address(USDC), int256(0), int256(1e20), address(0), alice, abi.encode(alice));
        mockProtocolWithInterest.operate(address(USDC), int256(0), int256(1e20), address(0), alice, abi.encode(alice));
    ...
    function test_operate_OperateAmountWorksForBorrow() public {
        ...
        // borrow
        vm.prank(alice);
        mockProtocol.operate(address(USDC), int256(0), int256(1e24), address(0), alice, abi.encode(alice));
        vm.prank(alice);
        mockProtocol.operate(address(USDC), int256(0), int256(1e28), address(0), alice, abi.encode(alice));
    ...
    function test_operate_RevertOperateAmountInsufficientWhenTotalBorrow() public {
        ...
        mockProtocol.operate(address(USDC), int256(0), int256(1e28), address(0), alice, abi.encode(alice));
        vm.prank(alice);
        mockProtocolWithInterest.operate(address(USDC), int256(0), int256(1e24), address(0), alice, abi.encode(alice));
        vm.prank(alice);
