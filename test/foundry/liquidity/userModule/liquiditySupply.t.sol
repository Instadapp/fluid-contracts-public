...
contract LiquidityUserModuleSupplyTests is LiquidityUserModuleBaseTest {
    function test_operate_RevertSupplyOperateAmountRatioExcess() public {
        vm.prank(alice);
        ...
        // execute operate
        vm.prank(alice);
        mockProtocol.operate(address(USDC), 1e26 + 1, int256(0), address(0), address(0), abi.encode(alice));
