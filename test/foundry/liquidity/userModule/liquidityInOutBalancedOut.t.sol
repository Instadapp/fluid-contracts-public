...
contract LiquidityUserModuleInOutBalancedOutTests is LiquidityUserModuleBaseTest {
    function setUp() public virtual override {
        ...
        // create liquidity
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 10 * DEFAULT_SUPPLY_AMOUNT);
        _supplyNative(address(liquidity), mockProtocol, alice, 10 * DEFAULT_SUPPLY_AMOUNT);
    }
...
contract LiquidityUserModuleInOutBalancedOutEncodingTests is LiquidityUserModuleBaseTest {
    function setUp() public virtual override {
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 10 * DEFAULT_SUPPLY_AMOUNT); // create liquidity
    }
