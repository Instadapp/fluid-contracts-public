...
contract LiquidityUserModulePaybackTests is LiquidityUserModuleBaseTest {
    ...
    function test_operate_RevertPaybackOperateAmountRatioExcess() public {
        ...
        // borrow in steps
        vm.prank(alice);
        mockProtocol.operate(address(USDC), int256(0), 1e22, address(0), alice, abi.encode(alice));
        vm.prank(alice);
        mockProtocol.operate(address(USDC), int256(0), 1e26, address(0), alice, abi.encode(alice));
        vm.prank(alice);
        mockProtocol.operate(address(USDC), int256(0), 1e30, address(0), alice, abi.encode(alice));
        ...
        // execute operate
        vm.prank(alice);
        mockProtocol.operate(address(USDC), int256(0), -int256(5.5e29), address(0), address(0), abi.encode(alice));

        vm.prank(alice);
        mockProtocol.operate(address(USDC), int256(0), -int256(4.5e29), address(0), address(0), abi.encode(alice));
    }
