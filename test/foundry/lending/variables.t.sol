...
contract VariablesExposed is Variables {
    ...
    function rescueFunds(address) external pure {
        revert("Not implemented");
    }

    function rebalance() external payable returns (uint256) {
        revert("Not implemented");
    }

    function updateRebalancer(address) external pure {
        revert("Not implemented");
    }
    ...
    function updateRates() external pure returns (uint256, uint256) {
        revert("Not implemented");
    }
    ...
    function updateRewards(IFluidLendingRewardsRateModel) external pure {
        revert("Not implemented");
    }
