...
contract FluidLendingStakingRewardsGeneralTest is FluidLendingStakingRewardsBaseTest {
    ...
    function _compareFTokenDetails(
        ...
        assertEq(actualFTokenDetails.relativeModelRate, expectedFTokenDetails.relativeModelRate);
        assertEq(actualFTokenDetails.staticModelRate, expectedFTokenDetails.staticModelRate);
        assertEq(actualFTokenDetails.isStaticRate, expectedFTokenDetails.isStaticRate);
        assertEq(actualFTokenDetails.rewardsActive, expectedFTokenDetails.rewardsActive);
        assertEq(actualFTokenDetails.liquidityRate, expectedFTokenDetails.liquidityRate);
        assertEq(actualFTokenDetails.totalRate, expectedFTokenDetails.totalRate);
        assertEq(actualFTokenDetails.rebalanceDifference, expectedFTokenDetails.rebalanceDifference);
        assertEq(actualFTokenDetails.accessType, expectedFTokenDetails.accessType);
        assertEq(
