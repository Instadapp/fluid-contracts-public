...
abstract contract FluidLendingStakingRewardsBaseTest is fTokenBaseSetUp {
    ...
    function setUp() public virtual override {
        ...
        lendingResolver = IFluidLendingResolver(address(
...
contract FluidLendingStakingRewardsNotifyRewardAmountTest is FluidLendingStakingRewardsBaseTest {
    ...
    function test_notifyRewardAmount_Unauthorized() public {
...
contract FluidLendingStakingRewardsGeneralTest is FluidLendingStakingRewardsBaseTest {
    ...
    function test_general() public {
        _assertFTokenStakingRewardsEntireData(0, 0,0,0,0, rewardsDuration,address(rewardsToken),address(stakingToken));
        ...
        _assertFTokenStakingRewardsEntireData(0, 115740740740 * rewardsDuration,0, lastNotifyTimestamp + rewardsDuration, 115740740740, rewardsDuration,address(rewardsToken),address(stakingToken));
        ...
        // reward per token = 0 / 1e18
        assertEq(stakingRewards.rewardPerTokenStored(), 0);
        _assertFTokenStakingRewardsEntireData(0, 115740740740 * rewardsDuration,3e18, lastNotifyTimestamp + rewardsDuration, 115740740740, rewardsDuration,address(rewardsToken),address(stakingToken));
        ...
        _assertFTokenStakingRewardsEntireData(83333333332800000, 115740740740 * rewardsDuration, 2e18, lastNotifyTimestamp + rewardsDuration, 115740740740, rewardsDuration,address(rewardsToken),address(stakingToken));
        ...
        _assertFTokenStakingRewardsEntireData(124999999999200000, 115740740740 * rewardsDuration, 6e18, lastNotifyTimestamp + rewardsDuration, 115740740740, rewardsDuration,address(rewardsToken),address(stakingToken));
        _assertUserRewardsData(alice, address(stakingToken), stakingRewards.earned(alice), 0, 0, type(uint256).max);
        _assertUserRewardsData(bob, address(stakingToken), stakingRewards.earned(bob), 2e18, 2e18, type(uint256).max);
        _assertUserRewardsData(michal, address(stakingToken), stakingRewards.earned(michal), 4e18, 4e18, type(uint256).max);
        _assertAllUsersPositions();
        ...
        _assertFTokenStakingRewardsEntireData(158333333332320000, 115740740740 * rewardsDuration, 6e18, lastNotifyTimestamp + rewardsDuration, 115740740740, rewardsDuration,address(rewardsToken),address(stakingToken));
        _assertUserRewardsData(alice, address(stakingToken), stakingRewards.earned(alice), 0, 0, type(uint256).max);
        _assertUserRewardsData(bob, address(stakingToken), stakingRewards.earned(bob), 2e18, 2e18, type(uint256).max);
        _assertUserRewardsData(michal, address(stakingToken), stakingRewards.earned(michal), 4e18, 4e18, type(uint256).max);
        _assertAllUsersPositions();
        ...
        _assertFTokenStakingRewardsEntireData(229999999998816000, 497685185184 * rewardsDuration, 6e18, lastNotifyTimestamp + rewardsDuration, 497685185184, rewardsDuration,address(rewardsToken),address(stakingToken));
        _assertUserRewardsData(alice, address(stakingToken), stakingRewards.earned(alice), 0, 0, type(uint256).max);
        _assertUserRewardsData(bob, address(stakingToken), stakingRewards.earned(bob), 2e18, 2e18, type(uint256).max);
        _assertUserRewardsData(michal, address(stakingToken), stakingRewards.earned(michal), 4e18, 4e18, type(uint256).max);
        _assertAllUsersPositions();
        ...
        _assertFTokenStakingRewardsEntireData(283749999998688000, 497685185184 * rewardsDuration, 8e18, lastNotifyTimestamp + rewardsDuration, 497685185184, rewardsDuration,address(rewardsToken),address(stakingToken));
        _assertUserRewardsData(alice, address(stakingToken), stakingRewards.earned(alice), 2e18, 2e18, type(uint256).max);
        _assertUserRewardsData(bob, address(stakingToken), stakingRewards.earned(bob), 2e18, 2e18, type(uint256).max);
        _assertUserRewardsData(michal, address(stakingToken), stakingRewards.earned(michal), 4e18, 4e18, type(uint256).max);
        _assertAllUsersPositions();
        ...
        _assertFTokenStakingRewardsEntireData(391249999998432000, 497685185184 * rewardsDuration, 8e18, lastNotifyTimestamp + rewardsDuration, 497685185184, rewardsDuration,address(rewardsToken),address(stakingToken));
        ...
        _assertFTokenStakingRewardsEntireData(1036249999996896000, 497685185184 * rewardsDuration, 4e18, lastNotifyTimestamp + rewardsDuration, 497685185184, rewardsDuration,address(rewardsToken),address(stakingToken));
    ...
    function _exitAndAssertStAndRwrdTokenBalance(address user, uint stTokenBalanceChange, uint rwrdTokenBalanceChange) internal {
    ...
    function _getRewardAndAssertStAndRwrdTokenBalance(address user, uint stTokenBalanceChange, uint rwrdTokenBalanceChange) internal {
        uint256 userStTokenBalanceBefore = stakingToken.balanceOf(user);
        uint256 userRwrdTokenBalanceBefore = rewardsToken.balanceOf(user);
        vm.prank(user);
    ...
    function _assertFTokenStakingRewardsEntireData(uint rewardPerToken, uint getRewardForDuration, uint totalSupply, uint periodFinish, uint rewardRate, uint rewardsDuration, address rewardsToken, address fToken) internal {
        Structs.FTokenStakingRewardsDetails memory details = stakingRewardsResolver.getFTokenStakingRewardsEntireData(address(stakingRewards));
        ...
        Structs.FTokenStakingRewardsDetails[] memory detailss = stakingRewardsResolver.getFTokensStakingRewardsEntireData(rewards);
    ...
    function _assertUserRewardsData(address user, address fToken, uint earned, uint fTokenShares, uint underlyingAssets, uint ftokenAllowance) internal {
        FluidLendingResolverStructs.FTokenDetails memory fTokenDetails_ = lendingResolver.getFTokenDetails(IFToken(fToken));

        // getUserRewardsData function
        Structs.UserRewardDetails memory userRewardDetails = stakingRewardsResolver.getUserRewardsData(user,address(stakingRewards), fTokenDetails_);
        ...
        address[] memory rewards = new address[](1);
        rewards[0] = address(stakingRewards);
        FluidLendingResolverStructs.FTokenDetails[] memory fTokensDetails_ = new FluidLendingResolverStructs.FTokenDetails[](1);
        fTokensDetails_[0] = fTokenDetails_;
        Structs.UserRewardDetails[] memory userRewardsDetails = stakingRewardsResolver.getUserAllRewardsData(user, rewards, fTokensDetails_);
    ...
    function _assertUserPositions(address user) internal {
        address[] memory rewards = new address[](1);
        rewards[0] = address(stakingRewards);
        FluidLendingResolverStructs.FTokenDetailsUserPosition[] memory usersEntireData = lendingResolver.getUserPositions(user);

        FluidStakingRewardsResolver.underlyingTokenToRewardsMap[] memory underlyingTokenToRewardMap_ = new FluidStakingRewardsResolver.underlyingTokenToRewardsMap[](1);
        underlyingTokenToRewardMap_[0] = FluidStakingRewardsResolver.underlyingTokenToRewardsMap({underlyingToken:address(USDC), rewardContract:address(stakingRewards)});
        FluidStakingRewardsResolver.UserFTokenRewardsEntireData[] memory userRewardsEntireData = stakingRewardsResolver.getUserPositions(user, underlyingTokenToRewardMap_);
        ...
        FluidStakingRewardsResolver.FTokenStakingRewardsDetails memory fTokenStakingRewardsDetails = stakingRewardsResolver.getFTokenStakingRewardsEntireData(address(stakingRewards));
        _compareFTokenRewardsDetails(userRewardsEntireData[0].fTokenRewardsDetails, fTokenStakingRewardsDetails);
        _compareUserRewardData(userRewardsEntireData[0].userRewardsDetails, stakingRewardsResolver.getUserRewardsData(user, address(stakingRewards), usersEntireData[0].fTokenDetails));
    }

    function _compareFTokenDetails(FluidLendingResolverStructs.FTokenDetails memory actualFTokenDetails, FluidLendingResolverStructs.FTokenDetails memory expectedFTokenDetails) public {
        ...
        assertEq(actualFTokenDetails.liquidityUserSupplyData.modeWithInterest, expectedFTokenDetails.liquidityUserSupplyData.modeWithInterest);
        assertEq(actualFTokenDetails.liquidityUserSupplyData.supply, expectedFTokenDetails.liquidityUserSupplyData.supply);
        assertEq(actualFTokenDetails.liquidityUserSupplyData.withdrawalLimit, expectedFTokenDetails.liquidityUserSupplyData.withdrawalLimit);
        assertEq(actualFTokenDetails.liquidityUserSupplyData.lastUpdateTimestamp, expectedFTokenDetails.liquidityUserSupplyData.lastUpdateTimestamp);
        assertEq(actualFTokenDetails.liquidityUserSupplyData.expandPercent, expectedFTokenDetails.liquidityUserSupplyData.expandPercent);
        assertEq(actualFTokenDetails.liquidityUserSupplyData.expandDuration, expectedFTokenDetails.liquidityUserSupplyData.expandDuration);
        assertEq(actualFTokenDetails.liquidityUserSupplyData.baseWithdrawalLimit, expectedFTokenDetails.liquidityUserSupplyData.baseWithdrawalLimit);
        assertEq(actualFTokenDetails.liquidityUserSupplyData.withdrawableUntilLimit, expectedFTokenDetails.liquidityUserSupplyData.withdrawableUntilLimit);
        assertEq(actualFTokenDetails.liquidityUserSupplyData.withdrawable, expectedFTokenDetails.liquidityUserSupplyData.withdrawable);
    }

    function _compareUserPositions(FluidLendingResolverStructs.UserPosition memory actualUserPosition, FluidLendingResolverStructs.UserPosition memory expectedUserPosition) public {
    ...
    function _compareFTokenRewardsDetails(FluidStakingRewardsResolver.FTokenStakingRewardsDetails memory actualFTokenRewardsDetails, FluidStakingRewardsResolver.FTokenStakingRewardsDetails memory expectedFTokenRewardsDetails) public {
    ...
    function _compareUserRewardData(FluidStakingRewardsResolver.UserRewardDetails memory actualUserRewardDetails, FluidStakingRewardsResolver.UserRewardDetails memory expectedUserRewardDetails) public {
