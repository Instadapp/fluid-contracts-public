...
contract ERC4626Test is Test {
    ...
    function invariantMetadata() public virtual {
        assertEq(vault.name(), "Mock Token Vault");
        assertEq(vault.symbol(), "vwTKN");
        assertEq(vault.decimals(), 18);
    }

    function testMetadata(string calldata name, string calldata symbol) public virtual {
    ...
    function testSingleDepositWithdraw(uint128 amount) public virtual {
    ...
    function testSingleMintRedeem(uint128 amount) public virtual {
        if (amount == 0) amount = 1;
    ...
    function testMultipleMintDepositRedeemWithdraw() public virtual {
        // Scenario:
        // A = Alice, B = Bob
    ...
    function test_RevertWhen_DepositWithNotEnoughApproval() public virtual {
    ...
    function test_RevertWhen_WithdrawWithNotEnoughUnderlyingAmount() public virtual {
        underlying.mint(address(this), 0.5e18);
        underlying.approve(address(vault), 0.5e18);
    ...
    function test_RevertWhen_RedeemWithNotEnoughShareAmount() public virtual {
        underlying.mint(address(this), 0.5e18);
        underlying.approve(address(vault), 0.5e18);
    ...
    function test_RevertWhen_WithdrawWithNoUnderlyingAmount() public virtual {
        vm.expectRevert();
        vault.withdraw(1e18, address(this), address(this));
    }

    function test_RevertWhen_RedeemWithNoShareAmount() public virtual {
        vm.expectRevert();
        vault.redeem(1e18, address(this), address(this));
    }

    function test_RevertWhen_DepositWithNoApproval() public virtual {
        vm.expectRevert();
        vault.deposit(1e18, address(this));
    }

    function test_RevertWhen_MintWithNoApproval() public virtual {
        vm.expectRevert();
        vault.mint(1e18, address(this));
    }

    function test_RevertWhen_DepositZero() public virtual {
        vm.expectRevert();
    ...
    function test_RevertWhen_RedeemZero() public virtual {
        vm.expectRevert();
