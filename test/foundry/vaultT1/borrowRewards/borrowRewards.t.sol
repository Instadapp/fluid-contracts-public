...
contract VaultBorrowRewardsTest is VaultFactoryBaseTest, Events {
    ...
    function test_rebalance_ZeroPointFiveMagnifier() public {
        ...
        int256 tvlForOnePointFive = 99.9 ether;
        ...
        (uint256 calculatedMagnifierWithZeroBorrowRate, ) = vaultBorrowRewards.calculateBorrowMagnifier();
        assertEq(calculatedMagnifierWithZeroBorrowRate, 1e4);
    ...
    function test_rebalance_ZeroPointSeventyFiveMagnifier() public {
        int256 tvlForOnePointTwentyFive = 199 ether;
        ...
        assertEq(199000025692293028053, vaultBorrowRewards.vaultBorrowTVL());
