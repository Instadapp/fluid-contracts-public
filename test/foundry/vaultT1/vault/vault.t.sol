...
contract VaultT1Test is VaultT1BaseTest {
    ...
    function testLiquidate0Tick() public {
        ...
        FluidVaultLiquidationResolver liquidationResolver = new FluidVaultLiquidationResolver(IFluidVaultResolver(address(vaultResolver)));
        LiquidationResolverStructs.SwapData memory swapData = liquidationResolver.getSwapDataForVault(vault_);
        assertEq(swapData.inAmt, 0, "unexpected liquidation available");
        ...
        swapData = liquidationResolver.getSwapDataForVault(vault_);
        assertEq(swapData.inAmt, 1881160285369995569778);
