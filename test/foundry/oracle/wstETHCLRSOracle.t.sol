...
contract WstETHCLRSOracleTest is OracleTestSuite {
    ...
    function test_getExchangeRate() public {
        ...
        assertEq(expectedRate, 231610317215209519606);

        uint256 rate = oracle.getExchangeRate();
        assertEq(rate, expectedRate); // 2316.10317215209519606. 17 decimals because would be 6 decimals but scaled by 11 decimals more
    }
