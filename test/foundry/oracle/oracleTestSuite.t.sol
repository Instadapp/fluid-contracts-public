...
import { IWeETHsAccountant } from "../../../contracts/oracle/interfaces/external/IWeETHsAccountant.sol";
...
contract OracleTestSuite is Test {
    ...
    IWeETHsAccountant internal constant WEETHS_ACCOUNTANT =
        IWeETHsAccountant(0xbe16605B22a7faCEf247363312121670DFe5afBE);
