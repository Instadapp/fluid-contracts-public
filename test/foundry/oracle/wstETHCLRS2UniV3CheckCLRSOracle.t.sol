...
contract WstETHCLRS2UniV3CheckCLRSOracleTest is OracleTestSuite {
    ...
    function setUp() public override {
        ...
        oracle = new WstETHCLRS2UniV3CheckCLRSOracle(wstETHCLRS2Params, uniV3CheckOracleParams);
    }
    ...
    function test_getExchangeRate_FailExchangeRatesStETHChainlinkZero() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(Error.FluidOracleError.selector, ErrorTypes.WstETHCLRS2UniV3CheckCLRSOracle__ExchangeRateZero)
        );
