...
contract FluidRateAuthTestsRateV2 is RateAuthTest {
    ...
    function test_updateRateDataV2_revertWhenUnauthorized() public {
        ...
        vm.startPrank(bob);
        vm.expectRevert(
            abi.encodeWithSelector(Error.FluidConfigError.selector, ErrorTypes.RatesAuth__Unauthorized)
        );
    ...
    function test_updateRateDataV2_revertWhenCalledWithExcessRateChange() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(Error.FluidConfigError.selector, ErrorTypes.RatesAuth__NoUpdate)
        );
        handler.updateRateDataV2(rateStruct);
    ...
    function test_updateRateDataV2_revertIfCooldownNotPassed() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(Error.FluidConfigError.selector, ErrorTypes.RatesAuth__CooldownLeft)
        );
