...
abstract contract FluidMaxBorrowConfigHandlerTests is FluidMaxBorrowConfigHandlerBaseTest {
    ...
    function test_rebalance() public {
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 7.8 ether);
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, TVL_CHECKPOINT - 7.8 ether);
...
contract MaxBorrowConfigHandlerTestsWithInterest is FluidMaxBorrowConfigHandlerTests {
    ...
    function test_rebalance_setsRaw() public {
        ...
        _supply(address(liquidity), mockProtocol, address(USDC), alice, 7 ether);
