        ...
        try resolver.getAllDexesEntireData() returns (DexEntireData[] memory entireData) {
            ...
            for (uint i = 0; i < entireData.length; i++) {
                ...
                console.log(
                    ...
                    entireData[i].dexState.dexVariables.isCenterPriceShiftActive
                );
                ...
                console.log(
                    "  isRangePercentShiftActive:",
                    entireData[i].dexState.dexVariables.isRangePercentShiftActive
                );
                ...
                console.log(
                    "  isThresholdPercentShiftActive:",
                    entireData[i].dexState.dexVariables.isThresholdPercentShiftActive
                );
                console.log(
                    "  upperShiftThresholdPercent:",
                    _toString(entireData[i].dexState.dexVariables.upperShiftThresholdPercent)
                );
                console.log(
                    "  lowerShiftThresholdPercent:",
                    _toString(entireData[i].dexState.dexVariables.lowerShiftThresholdPercent)
                );
                ...
                console.log(
                    "  totalToken0AdjustedAmount:",
                    _toString(entireData[i].dexState.dexVariables.totalToken0AdjustedAmount)
                );
                console.log(
                    "  totalToken1AdjustedAmount:",
                    _toString(entireData[i].dexState.dexVariables.totalToken1AdjustedAmount)
                );
                ...
                console.log(
                    ...
                    _toString(entireData[i].dexState.centerPriceShift.lastInteractionTimestamp)
                );
                console.log(
                    "  rebalancingShiftingTime:",
                    _toString(entireData[i].dexState.centerPriceShift.rebalancingShiftingTime)
                );
                ...
                console.log(
                    "  centerPriceShiftingTime:",
                    _toString(entireData[i].dexState.centerPriceShift.centerPriceShiftingTime)
                );
                ...
                console.log(
                    "  oldUpperRangePercent:",
                    _toString(entireData[i].dexState.rangeShift.oldUpperRangePercent)
                );
                console.log(
                    "  oldLowerRangePercent:",
                    _toString(entireData[i].dexState.rangeShift.oldLowerRangePercent)
                );
                ...
                console.log(
                    "  oldUpperThresholdPercent:",
                    _toString(entireData[i].dexState.thresholdShift.oldUpperThresholdPercent)
                );
                console.log(
                    "  oldLowerThresholdPercent:",
                    _toString(entireData[i].dexState.thresholdShift.oldLowerThresholdPercent)
                );
