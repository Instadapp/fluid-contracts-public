...
contract FluidDexReservesResolverRobustnessTest is Test {
    IFluidDexFactory internal constant DEX_FACTORY = IFluidDexFactory(0x93DD426446B5370F094a1e31f19991AAA6Ac0bE0);
    ...
    address internal constant DEX_WSTETH_ETH = 0x6d83f60eEac0e50A1250760151E81Db2a278e03a;
    ...
    function test_allMethodsWithoutReverts() public {
        ...
        resolver.estimateSwapIn(DEX_WSTETH_ETH, true, 1e18, 0);
        resolver.estimateSwapOut(DEX_WSTETH_ETH, true, 1e18, 1e25);
        resolver.estimateSwapIn(DEX_WSTETH_ETH, false, 1e18, 0);
        resolver.estimateSwapOut(DEX_WSTETH_ETH, false, 1e18, 1e25);
