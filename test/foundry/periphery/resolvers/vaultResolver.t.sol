...
contract FluidVaultResolverRobustnessTest is Test {
    ...
    function setUp() public virtual {
        ...
        resolver = new FluidVaultResolver(address(VAULT_FACTORY), address(LIQUIDITY), address(liquidityResolver));
