...
abstract contract StETHQueueBaseTest is LiquidityBaseTest, Events {
    ...
    function setUp() public virtual override {
        ...
        _supplyNative(address(liquidity), mockProtocol, alice, DEFAULT_ETH_SUPPLIED);
...
contract StETHQueueTestClaim is StETHQueueBaseTest {
    ...
    function test_claim_WithYield() public {
        ...
        _withdrawNative(address(liquidity), mockProtocol, alice, DEFAULT_ETH_SUPPLIED - 100 ether - 1e12); // only 100 eth supplied afterwards. 1e12 from dust borrow
