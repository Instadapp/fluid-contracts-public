...
abstract contract DexFactoryBaseTest is LiquidityBaseTest {
    ...
    function setUp() public virtual override {
        ...
        (address perfectOperationsAndSwapOut1_, address perfectOperationsAndSwapOut2_) = sStore2Deployer
            .deployCodeSplit(type(FluidDexT1PerfectOperationsAndSwapOut).creationCode);
