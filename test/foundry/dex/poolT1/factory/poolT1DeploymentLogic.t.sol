...
} from "../../../../../contracts/protocols/dex/poolT1/coreModule/core/colOperations.sol";
import {
    FluidDexT1OperationsDebt
} from "../../../../../contracts/protocols/dex/poolT1/coreModule/core/debtOperations.sol";
import { FluidDexT1 } from "../../../../../contracts/protocols/dex/poolT1/coreModule/core/main.sol";
import {
    FluidDexT1DeploymentLogic
} from "../../../../../contracts/protocols/dex/factory/deploymentLogics/poolT1Logic.sol";
...
contract PoolT1DeploymentLogicTest is Test {
    function test_splitsCreationCodeCorrectly() public {
        ...
        // Use deployCodeSplit for col and debt operations code (new logic wants two SSTORE2 addresses for each)
        (address colOperations1_, address colOperations2_) = sStore2Deployer.deployCodeSplit(
            type(FluidDexT1OperationsCol).creationCode
        );
        (address debtOperations1_, address debtOperations2_) = sStore2Deployer.deployCodeSplit(
            type(FluidDexT1OperationsDebt).creationCode
        );

        // SSTORE2 splits for main FluidDexT1 creation code
