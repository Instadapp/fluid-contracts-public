...
contract PoolT1PoC is PoolT1BaseTest {
    ...
    function test_POCArbitrageAttack() public {
        ...
        console.log(
            "Withdraw profit",
            (withdrawAmount0_ / DAI_USDC.token0Wei) + (withdrawAmount1_ / DAI_USDC.token1Wei),
            (depositAmount1_ / DAI_USDC.token1Wei) + (depositAmount0_ / DAI_USDC.token0Wei)
        );
        ...
        console.log(
            "Payback profit",
            (borrowAmount1_ / DAI_USDC.token1Wei) + (borrowAmount0_ / DAI_USDC.token0Wei),
            (paybackAmount0_ / DAI_USDC.token0Wei) + (paybackAmount1_ / DAI_USDC.token1Wei)
        );
    }
