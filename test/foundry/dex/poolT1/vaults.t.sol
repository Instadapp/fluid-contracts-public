...
} from "../../../../contracts/protocols/vault/factory/deploymentLogics/vaultT1Logic_not_for_prod.sol";
import {
    FluidVaultT2DeploymentLogic
} from "../../../../contracts/protocols/vault/factory/deploymentLogics/vaultT2Logic.sol";
import {
    FluidVaultT3DeploymentLogic
} from "../../../../contracts/protocols/vault/factory/deploymentLogics/vaultT3Logic.sol";
import {
    FluidVaultT4DeploymentLogic
} from "../../../../contracts/protocols/vault/factory/deploymentLogics/vaultT4Logic.sol";
...
} from "../../../../contracts/protocols/vault/vaultT1_not_for_prod/adminModule/main.sol";
import {
    FluidVaultT1_Not_For_Prod
} from "../../../../contracts/protocols/vault/vaultT1_not_for_prod/coreModule/main.sol";
import {
    FluidVaultT1Operate_Not_For_Prod
} from "../../../../contracts/protocols/vault/vaultT1_not_for_prod/coreModule/mainOperate.sol";
...
contract VaultsBaseTest is VaultFactoryBaseTest, PoolT1BaseTest {
    ...
    function setUp() public virtual override(PoolT1BaseTest, VaultFactoryBaseTest) {
        ...
        _vaultPositionsResolver = new FluidVaultPositionsResolver(IFluidVaultFactory(address(vaultFactory)));
