...
The ranges above are `contracts/oracleV1_DEPRECATED/`. `contracts/oracleV2/` uses the 310xxx block, one
sub-range per module:

- **USD oracle** - Prefix: UsdOracle\_\_:
  - **Range:** 310001-310099
- **Vault oracle** - Prefix: VaultOracle\_\_ / VaultOracleFactory\_\_:
  - **Range:** 310101-310199
- **Oracle v2 common** - Prefix: OracleV2Common\_\_ / FluidOracle\_\_:
  - **Range:** 310201-310299
- **Stock oracles** - Prefix: UsEquityMarketHours\_\_ / CLXStockOracle\_\_:
  - **Range:** 310301-310399
...
### 11. Permissioned stack

- **PermissionGate** - Error: `FluidPermissionGateError`, IDs in `permissioned/permissionGate/errorTypes.sol`:
  - **Range:** 501001-501999
- **Permissioned protocols (shared across lending / vault / swap wrappers)** - Error: `FluidPermissionedError`, IDs in `permissioned/errorTypes.sol`:
  - **Range:** 502001-502999
