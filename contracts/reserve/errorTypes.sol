...
library ErrorTypes {
    ...
    /// @notice thrown when an unauthorized caller is trying to call a governance only function
    uint256 internal constant ReserveContract__OnlyGovernanceAllowed = 90007;
}
