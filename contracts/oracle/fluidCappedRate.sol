...
abstract contract FluidCappedRateBase is CappedRateInternals, CappedRateAdmin, IFluidCappedRate {
    ...
    constructor(
        ...
        _slot0.rate = uint168(_getNewRate1e27());
    ...
    /// @notice returns true if last update timestamp is > min heartime update time ago so heartbeat update should trigger
