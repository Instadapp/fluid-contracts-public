...
abstract contract DexSmartDebtPegOracleImpl is DexViews, OracleError {
    ...
    /// @return dexSharesDecimals_ The number of decimals for Dex shares.
    /// @return dexTokensDecimalsPrecision_ The number of decimals for Dex tokens precision.
    ...
    function dexSmartDebtOracleData()
        ...
        returns (
            address dexPool_,
            uint256 reservesPegBufferPercent_,
            uint8 dexSharesDecimals_,
            uint8 dexTokensDecimalsPrecision_,
