...
library LiquiditySlotsLink {
    ...
    uint256 internal constant BITS_EXCHANGE_PRICES_PAUSE_TOKEN = 255;
    ...
    function calculateDoubleMappingStorageSlot(
        ...
        address key1_,
        address key2_
    ) internal pure returns (bytes32 storageSlot_) {
        storageSlot_ = keccak256(abi.encode(key1_, slot_));
        return keccak256(abi.encode(key2_, storageSlot_));
    }
}
