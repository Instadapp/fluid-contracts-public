...
contract FluidSmartLending is ERC20, Variables, Error, ReentrancyGuard, Events {
    ...
    function deposit(
        ...
        uint256 value_ = !IS_NATIVE_PAIR ? 0 : (TOKEN0 == ETH_ADDRESS) ? token0Amt_ : token1Amt_;
        ...
        returns (uint256 shares_, uint256 token0Amt_, uint256 token1Amt_, bool isWithdraw_)
    {
        ...
        if (rebalanceDiff_ > 0) {
            ...
            uint256 value_ = !IS_NATIVE_PAIR ? 0 : (TOKEN0 == ETH_ADDRESS) ? minOrMaxToken0_ : minOrMaxToken1_;
