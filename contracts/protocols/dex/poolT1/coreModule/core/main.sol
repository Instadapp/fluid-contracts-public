...
contract FluidDexT1 is CoreHelpers {
    ...
    function _swapIn(
        ...
        if (temp_ > 0) {
            ...
            temp2_ = (temp_ * s_.fee);
            unchecked {
                temp2_ = temp2_ / SIX_DECIMALS;
            }
            temp2_ = _getAmountOut(temp2_, cs_.tokenInImaginaryReserves, cs_.tokenOutImaginaryReserves);
            swap0to1_
        ...
        if (temp3_ > 0) {
            ...
            temp4_ = (temp3_ * s_.fee);
            unchecked {
                temp4_ = temp4_ / SIX_DECIMALS;
            }
            temp4_ = _getAmountOut(temp4_, ds_.tokenInImaginaryReserves, ds_.tokenOutImaginaryReserves);
            swap0to1_
                ? _verifyToken1Reserves(
        ...
        temp_ = (temp_ * s_.revenueCut);
        temp3_ = (temp3_ * s_.revenueCut);

        unchecked {
            temp_ = temp_ / EIGHT_DECIMALS;
            temp3_ = temp3_ / EIGHT_DECIMALS;
        }
    ...
    function _swapOut(
        ...
        temp2_ = temp2_ * s_.revenueCut;
        temp4_ = temp4_ * s_.revenueCut;
        unchecked {
            temp2_ = temp2_ / EIGHT_DECIMALS;
            temp4_ = temp4_ / EIGHT_DECIMALS;
        }
    ...
    function swapOut(
        ...
        address to_
    ) public payable returns (uint amountIn_) {
    ...
    function depositPerfect(
        ...
        return abi.decode(_spell(COL_OPERATIONS_IMPLEMENTATION, msg.data), (uint256, uint256));
    }
    ...
    function borrowPerfect(
        ...
        return abi.decode(_spell(DEBT_OPERATIONS_IMPLEMENTATION, msg.data), (uint256, uint256));
    }
    ...
    function withdraw(uint token0Amt_, uint token1Amt_, uint maxSharesAmt_, address to_) public returns (uint shares_) {
        return abi.decode(_spell(COL_OPERATIONS_IMPLEMENTATION, msg.data), (uint256));
    }
    ...
    function borrow(uint token0Amt_, uint token1Amt_, uint maxSharesAmt_, address to_) public returns (uint shares_) {
    ...
    ) external pure returns (Oracle[] memory twaps_, uint currentPrice_) {
    ...
    function constantsView() external view returns (ConstantViews memory constantsView_) {
        ...
        constantsView_.implementations.perfectOperationsAndSwapOut = address(0);
        ...
        constantsView_.oracleMapping = 0;
    }
