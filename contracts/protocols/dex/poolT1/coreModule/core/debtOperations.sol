        ...
        if (((dexVariables2_ >> 1) & 1) == 1) {
            ...
            if ((token0Debt_ > 0) && (token1Debt_ > 0)) {
                if (b_.token0AmtAdjusted > 0 && b_.token1AmtAdjusted > 0) {
                    ...
                    if (temp_ > temp2_) {
                        // use temp2_ shares
                        shares_ = (temp2_ * totalBorrowShares_);
                        // temp_ => token0 to swap
                        temp_ = ((temp_ - temp2_) * token0Debt_);
                        temp2_ = 0;
                    } else if (temp2_ > temp_) {
                        // use temp1_ shares
                        shares_ = (temp_ * totalBorrowShares_);
                        // temp2_ => token1 to swap
                        temp2_ = ((temp2_ - temp_) * token1Debt_);
                        temp_ = 0;
                    } else {
                ...
                temp_ = (temp_ * (SIX_DECIMALS + ((dexVariables2_ >> 2) & X17)));
                unchecked {
                    temp_ = temp_ / SIX_DECIMALS;
                }
            ...
            if ((d_.token0Debt > 0) && (d_.token1Debt > 0)) {
                if (p_.token0AmtAdjusted > 0 && p_.token1AmtAdjusted > 0) {
                    ...
                    if (temp_ > temp2_) {
                        ...
                        shares_ = (temp_ * totalBorrowShares_);
                        // temp2_ => token1 to swap
                        temp2_ = p_.token1AmtAdjusted - ((temp_ * p_.token1AmtAdjusted) / temp2_);
                        temp_ = 0;
                    } else {
                ...
                temp_ = (temp_ * totalBorrowShares_);
                unchecked {
                    temp_ = temp_ / 1e18;
                }
    ...
    function paybackPerfectInOneToken(
        ...
        if (((dexVariables2_ >> 1) & 1) == 1) {
            ...
            if (maxToken0_ > 0) {
                ...
                token0Amt_ = (token0Amt_ * (SIX_DECIMALS + ((dexVariables2_ >> 2) & X17)));
                unchecked {
                    token0Amt_ = token0Amt_ / SIX_DECIMALS;
                }
                ...
                // adding fee on paying back in 1 token
                token1Amt_ = (token1Amt_ * (SIX_DECIMALS + ((dexVariables2_ >> 2) & X17)));
                unchecked {
                    token1Amt_ = token1Amt_ / SIX_DECIMALS;
                }
