        ...
        if ((dexVariables2_ & 1) == 1) {
            ...
            if ((c_.token0RealReserves > 0) && (c_.token1RealReserves > 0)) {
                if (d_.token0AmtAdjusted > 0 && d_.token1AmtAdjusted > 0) {
                    ...
                    if (temp_ > temp2_) {
                        // use temp2_ shares
                        shares_ = (temp2_ * totalSupplyShares_);
                        // temp_ => token0 to swap
                        temp_ = ((temp_ - temp2_) * c_.token0RealReserves);
                        temp2_ = 0;
                    } else if (temp2_ > temp_) {
                        // use temp_ shares
                        shares_ = (temp_ * totalSupplyShares_);
                        // temp2_ => token1 to swap
                        temp2_ = ((temp2_ - temp_) * c_.token1RealReserves);
                        temp_ = 0;
                    } else {
            ...
            if ((token0Reserves_ > 0) && (token1Reserves_ > 0)) {
                if (w_.token0AmtAdjusted > 0 && w_.token1AmtAdjusted > 0) {
                    ...
                    if (temp_ > temp2_) {
                        ...
                        shares_ = (temp2_ * totalSupplyShares_);
                        // temp_ => token0 to swap
                        temp_ = (temp_ - temp2_) * token0Reserves_;
                        temp2_ = 0;
                    } else if (temp2_ > temp_) {
                        // use temp1_ shares
                        shares_ = (temp_ * totalSupplyShares_);
                        // temp2_ => token1 to swap
                        temp2_ = (temp2_ - temp_) * token1Reserves_;
                        temp_ = 0;
                    } else {
