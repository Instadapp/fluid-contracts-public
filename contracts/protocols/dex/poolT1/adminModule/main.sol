...
contract FluidDexT1Admin is ConstantVariables, Variables, Structs, Events, Error {
    ...
    ///      Used as a helper for `_onlyDelegateCall` modifier.
    ...
    function updateHookAddress(uint hookAddress_) public view _check _onlyDelegateCall {
        revert FluidDexError(ErrorTypes.DexT1Admin__NotSupported);
    }
    ...
    function toggleOracleActivation(bool turnOn_) external view _onlyDelegateCall {
        revert FluidDexError(ErrorTypes.DexT1Admin__NotSupported);
    }
}
