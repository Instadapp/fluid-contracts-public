...
library ErrorTypes {
    ...
    /***********************************|
    |    Lending Static Rate Model      |
    |__________________________________*/

    /// @notice thrown when msg.sender is not the configurator for admin methods
    uint256 internal constant LendingStaticRateModel__Unauthorized = 24001;

    /// @notice thrown when invalid params are given as input
    uint256 internal constant LendingStaticRateModel__InvalidParams = 24002;

    /// @notice thrown when static rate exceeds the maximum rate
    uint256 internal constant LendingStaticRateModel__MaxRate = 24003;

    /// @notice thrown when static rate program is already stopped / ended
    uint256 internal constant LendingStaticRateModel__AlreadyStopped = 24004;
}
