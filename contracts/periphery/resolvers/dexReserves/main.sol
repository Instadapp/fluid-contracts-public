...
abstract contract DexSwapLimits is Variables, Structs, DexConstantsViews, ResolverHelpers {
...

        {
            ...
            /// Next 10 bits => 238-247 => utilization limit of token1. Max value 1000 = 100%, if 100% then no need to check the utilization.
            {
                ...
                if (liquidityTokenData0_.totalBorrow < maxUtilizationToken0_) {
                    ...
                    balanceLiquidity_ += _getLiquidityExternalBalances(token0_, address(LIQUIDITY));
...

            {
                ...
                if (liquidityTokenData1_.totalBorrow < maxUtilizationToken1_) {
                    ...
                    balanceLiquidity_ += _getLiquidityExternalBalances(token1_, address(LIQUIDITY));
