...
function testSwapInVerifyReserves() {
  ...
  const result = swapInAdjusted(true, 83298735295 * 0.01, reserves, reserves, outDecimals, limitsWide, syncTime);
  console.log(result);
...
function testSwapOutVerifyReserves() {
  ...
  // using equal reserves for col and debt
  const result = swapOutAdjusted(false, 83298735295 * 0.01, reserves, reserves, outDecimals, limitsWide, syncTime);
  console.log(result);
...
function testSwapInVerifyReservesInRange() {
  ...
  let result = swapInAdjusted(true, swapAmount_ * 1e6 * 1e6, reserves, reservesEmpty, decimals, limitsWide, syncTime);
  ...
  result = swapInAdjusted(true, swapAmount_ * 1e6 * 1e6, reservesEmpty, reserves, decimals, limitsWide, syncTime);
  ...
  result = swapInAdjusted(true, swapAmount_ * 1e6 * 1e6, reserves, reservesEmpty, decimals, limitsWide, syncTime);
  console.log(`result for col reserves when swap amount ${swapAmount_} : ${result}`);
